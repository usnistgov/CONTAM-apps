...
function InputsController($state, InputsService) {
	...
	if(InputsService.hasInputs()) {
		...
		inputsCtrl.inputs.residential.houseTimeToMetric = {baseValue: 7200, conversion: 2, label: "Time to Metric",
			unitStrings: CONTAM.Units.Strings2.Time, unitFunction: CONTAM.Units.TimeConvert, min: 1};
		inputsCtrl.inputs.residential.roomTimeToMetric = {baseValue: 21600, conversion: 2, label: "Time to Metric",
			unitStrings: CONTAM.Units.Strings2.Time, unitFunction: CONTAM.Units.TimeConvert, min: 1};
	...
	inputsCtrl.resHouseData = [
		...
		{CO2Outdoor: 400, floorArea: 250, ceilingHeight: 2.74, timeToMetric: 6, numBedrooms: 5, ach: 0.5, achpp: 15.9, scenario: 'Bedroom', method: 'ACHP', bedFloorArea: 30, numWholeOccupants: 6, occupants: 2}, // big house big family ACH Perfect (primary)
		{CO2Outdoor: 400, floorArea: 250, ceilingHeight: 2.74, timeToMetric: 6, numBedrooms: 5, ach: 0.5, achpp: 15.9, scenario: 'Bedroom', method: 'ACHP', bedFloorArea: 20, numWholeOccupants: 6, occupants: 4}, // big house big family ACH Perfect (child)
		{CO2Outdoor: 400, floorArea: 250, ceilingHeight: 2.74, timeToMetric: 6, numBedrooms: 5, ach: 0.5, achpp: 5.7, scenario: 'Bedroom', method: 'ACHU', bedFloorArea: 30, numWholeOccupants: 6, occupants: 2}, // big house big family ACH Uniform (primary)
		{CO2Outdoor: 400, floorArea: 250, ceilingHeight: 2.74, timeToMetric: 6, numBedrooms: 5, ach: 0.5, achpp: 7.6, scenario: 'Bedroom', method: 'ACHU', bedFloorArea: 20, numWholeOccupants: 6, occupants: 4}, // big house big family ACH Uniform (child)
		...
		{CO2Outdoor: 400, floorArea: 100, ceilingHeight: 2.44, timeToMetric: 6, numBedrooms: 3, ach: 0.5, achpp: 8.5, scenario: 'Bedroom', method: 'ACHP', bedFloorArea: 20, numWholeOccupants: 4, occupants: 2}, // little house normal family ACH Perfect (primary)
		{CO2Outdoor: 400, floorArea: 100, ceilingHeight: 2.44, timeToMetric: 6, numBedrooms: 3, ach: 0.5, achpp: 8.5, scenario: 'Bedroom', method: 'ACHP', bedFloorArea: 15, numWholeOccupants: 4, occupants: 3}, // little house normal family ACH Perfect (child)
		{CO2Outdoor: 400, floorArea: 100, ceilingHeight: 2.44, timeToMetric: 6, numBedrooms: 3, ach: 0.5, achpp: 3.4, scenario: 'Bedroom', method: 'ACHU', bedFloorArea: 20, numWholeOccupants: 4, occupants: 2}, // little house normal family ACH Uniform (primary)
		{CO2Outdoor: 400, floorArea: 100, ceilingHeight: 2.44, timeToMetric: 6, numBedrooms: 3, ach: 0.5, achpp: 5.1, scenario: 'Bedroom', method: 'ACHU', bedFloorArea: 15, numWholeOccupants: 4, occupants: 3}, // little house normal family ACH Uniform (child)
  ...
  inputsCtrl.calculateResUser = function(){
    ...
    if(inputsCtrl.inputs.residential.resType == 'Whole House') {
      ...
      // convert from seconds to hours
      timeToMetric = CONTAM.Units.TimeConvert(inputsCtrl.inputs.residential.houseTimeToMetric.baseValue, 2, 0);
    } else {
      ...
      // convert from seconds to hours
      timeToMetric = CONTAM.Units.TimeConvert(inputsCtrl.inputs.residential.roomTimeToMetric.baseValue, 2, 0);
    }
    occupants.showRemove = false;
	...
	inputsCtrl.validateInputs = function () {
		...
		if(inputsCtrl.inputs.SpaceCategory =='com') {
          ...
          if(inputsCtrl.inputs.residential.houseTimeToMetric.baseValue == null) {
            alert(inputsCtrl.inputs.residential.houseTimeToMetric.label + message);
            return true;
          }
				} else {
          ...
          if(inputsCtrl.inputs.residential.roomTimeToMetric.baseValue == null) {
            alert(inputsCtrl.inputs.residential.roomTimeToMetric.label + message);
            return true;
          }
				}				
			} else {
