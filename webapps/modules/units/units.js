...
class UnitConverter {
    ...
    {
        return [
            "length", "time", "mass", "temperature", "pressure", "mass flow rate", "area", "volume", "speed", "vol flow", "per unit length", "per unit area", 
            "conss", "dep flow", "time const", "density", "duct leak", "moldif", "spec heat", "concen", "concen surf", "energy", "therm cond", "power", 
            "power area", "occ dens", "flow area", "vol flow area", "integrated conc", "vol concen", "none"
        ];
    }
    ...
    getUnits(unitType)
    {
        var unitTypes = new Map([
            ...
            ["mass", [
                ...
                {displayString: "cm3", simpleString: "cm3e"},
                {displayString: "ft3", simpleString: "ft3e"},
                {displayString: "in3", simpleString: "in3e"},
                {displayString: "L", simpleString: "Le"},
                {displayString: "\xB5L", simpleString: "uLe"},
                {displayString: "sm3", simpleString: "m3s"},
                {displayString: "scm3", simpleString: "cm3s"},
                {displayString: "sft3", simpleString: "ft3s"},
                {displayString: "sin3", simpleString: "in3s"},
                {displayString: "sL", simpleString: "Ls"},
                {displayString: "s\xB5L", simpleString: "uLs"},
            ]],
            ["temperature", [
            ...
            ["mass flow rate", [
                ...
                {displayString: "scfm", simpleString: "ft3s/min"},
                {displayString: "sL/s", simpleString: "Ls/s"},
                {displayString: "sm\xB3/s", simpleString: "m3s/s"},
                {displayString: "sm\xB3/h", simpleString: "m3s/h"},
                {displayString: "lb/s", simpleString: "lb/s"},
                {displayString: "sft\xB3/h", simpleString: "ft3s/h"},
                {displayString: "sL/min", simpleString: "Ls/min"},
            ...
            ["vol flow", [
                ...
                {displayString: "cfm", simpleString: "ft3e/min"},
            ...
            ["dep flow", [
                ...
                {displayString: "sm\xB3/s", simpleString: "m3s/s"},
                {displayString: "sL/s", simpleString: "Ls/s"},
                {displayString: "smL/s", simpleString: "mLs/s"},
                {displayString: "s\xB5L/s", simpleString: "uLs/s"},
                {displayString: "kg/min", simpleString: "kg/min"},
                {displayString: "lb/min", simpleString: "lb/min"},
                {displayString: "g/min", simpleString: "g/min"},
                {displayString: "mg/min", simpleString: "mg/min"},
                {displayString: "\xB5g/min", simpleString: "ug/min"},
                {displayString: "ng/min", simpleString: "ng/min"},
                {displayString: "sm\xB3/min", simpleString: "m3s/min"},
                {displayString: "sL/min", simpleString: "Ls/min"},
                {displayString: "smL/min", simpleString: "mLs/min"},
                {displayString: "s\xB5L/min", simpleString: "uLs/min"},
                {displayString: "kg/h", simpleString: "kg/h"},
                {displayString: "lb/h", simpleString: "lb/h"},
                {displayString: "g/h", simpleString: "g/h"},
                {displayString: "mg/h", simpleString: "mg/h"},
                ...
                {displayString: "ng/h", simpleString: "ng/h"},
                {displayString: "sm\xB3/h", simpleString: "m3s/h"},
                {displayString: "sL/h", simpleString: "Ls/h"},
                {displayString: "smL/h", simpleString: "mLs/h"},
                {displayString: "s\xB5L/h", simpleString: "uLs/h"},
                {displayString: "#/s", simpleString: "#/s"},
                {displayString: "#/min", simpleString: "#/min"},
                {displayString: "#/h", simpleString: "#/h"},
            ]],
            ...
            ["concen", [
                ...
                {displayString: "ft\xB3/lb", simpleString: "ft3e/lb"},
                {displayString: "ft\xB3/ft\xB3", simpleString: "ft3e/ft3s"},
            ...
            ["vol concen", [
                ...
                {displayString: "\xB5g/m\xB3", simpleString: "ug/m3s"},
                {displayString: "#/m\xB3", simpleString: "#/m3s"},
                {displayString: "kg/L", simpleString: "kg/Ls"},
                {displayString: "g/L", simpleString: "g/Ls"},
                {displayString: "mg/L", simpleString: "mg/Ls"},
                {displayString: "\xB5g/L", simpleString: "ug/Ls"},
                {displayString: "#/L", simpleString: "#/Ls"},
                {displayString: "kg/cm\xB3", simpleString: "kg/cm3s"},
                {displayString: "g/cm\xB3", simpleString: "g/cm3s"},
                {displayString: "mg/cm\xB3", simpleString: "mg/cm3s"},
                {displayString: "\xB5g/cm\xB3", simpleString: "ug/cm3s"},
                {displayString: "#/cm\xB3", simpleString: "#/cm3s"},
                {displayString: "lb/ft\xB3", simpleString: "lb/ft3s"},
                {displayString: "#/ft\xB3", simpleString: "#/ft3s"},
                {displayString: "lb/in\xB3", simpleString: "lb/in3s"},
                {displayString: "#/in\xB3", simpleString: "#/in3s"},
            ]],
            ["none", []],
...
//\xB2 - squared 
    ...
    convertUnitToken(fromToken, toToken)
    {
        ...
        var massConversions = new Map([
            ...
            ["kg cm3e", value => value * 24.05 / this.mw * 1e6],
            ["kg ft3e", value => value * 24.05 * 35.3146 / this.mw],
            ["kg in3e", value => value * 24.05 * 61023.7440576 / this.mw],
            ...
            ["kg in3s", value => value / 1.20410 * 61023.7440576],
            ...
            ["cm3e kg", value => value / 1e6 * this.mw / 24.05],
            ["ft3e kg", value => value * this.mw / 35.3146 / 24.05],
            ["in3e kg", value => value * this.mw / 61023.7440576 / 24.05],
            ...
            ["in3s kg", value => value / 61023.7440576 * 1.20410],
        ...
        var groups = new Map([
            ...
            ["m3e", massConversions], ["cm3e", massConversions], ["ft3e", massConversions], ["in3e", massConversions], ["Le", massConversions], ["mLe", massConversions], 
            ["uLe", massConversions], ["m3s", massConversions], ["cm3s", massConversions], ["ft3s", massConversions], ["in3s", massConversions], ["Ls", massConversions], 
            ["mLs", massConversions], ["uLs", massConversions], ["J", energyConversions], ["Btu", energyConversions], ["kJ", energyConversions],
        ]);
        var conversionArray = [];
        var conversions;
